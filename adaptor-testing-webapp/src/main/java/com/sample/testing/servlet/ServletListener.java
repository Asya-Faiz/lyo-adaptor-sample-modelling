 ...
 * 2. In the web.xml file, set a "context-param" property, with name "com.sample.testing.servlet.baseurl"
...
public class ServletListener implements ServletContextListener  {
    ...
    private static String generateBasePath(final ServletContextEvent servletContextEvent) {
        return (getBasePathFromEnvironment().orElseGet(() -> getBasePathFromContext(servletContextEvent).orElseGet(() -> DEFAULT_BASE))) +
