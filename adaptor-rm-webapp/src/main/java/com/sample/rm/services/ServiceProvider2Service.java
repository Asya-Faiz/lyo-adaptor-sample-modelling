...
public class ServiceProvider2Service
{
    ...
    @Produces({OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_JSON_LD, OslcMediaType.TEXT_TURTLE, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON})
    public ServiceProvider getServiceProvider(@PathParam("id1") final String id1, @PathParam("id2") final String id2)
    {
        httpServletResponse.addHeader("Oslc-Core-Version","2.0");
        return ServiceProviderCatalogSingleton.getServiceProvider2(httpServletRequest, id1, id2);
    }
    ...
    public void getHtmlServiceProvider(@PathParam("id1") final String id1, @PathParam("id2") final String id2)
    {
        ServiceProvider serviceProvider = ServiceProviderCatalogSingleton.getServiceProvider2(httpServletRequest, id1, id2);
