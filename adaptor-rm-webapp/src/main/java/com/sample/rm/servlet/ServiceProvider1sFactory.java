...
public class ServiceProvider1sFactory
{
    ...
    public static URI constructURI(final ServiceProvider1Info serviceProviderInfo)
    {
    ...
    public static String constructIdentifier(final ServiceProvider1Info serviceProviderInfo)
    {
        return constructIdentifier(serviceProviderInfo.serviceProviderId);
    }

    public static ServiceProvider createServiceProvider(final ServiceProvider1Info serviceProviderInfo) 
